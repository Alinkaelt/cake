...
\emph{A \emph{normal form game} is a representation of a game in a tabular. In the case for two players the first player chooses the row while the second chooses the column. Each cell contains a tuple with the values of the obtained pieces, one per player.\begin{itemize}
...
\item[]If player $p_1$ chooses the strategy $Strategy_a$ and player $p_2$ the strategy $Strategy_I$:\\
...
\end{center}
\end{figure}
So player $p_1$ chooses his strategy first, and then it is player $p_2$'s move. Hereby, only player $p_2$ knows how player $p_1$ moved. The leafs are the end-states of the game with the values the players obtain on the right from them. Around the vertices is the strategy of the acting player. A red path indicates a suboptimal decision of the first player. Similar, a lightning behind a path indicates a bad choice of the second player.\\
\newline
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{center}
\end{figure}
\newline For John the tree shows that if he stays secure he would obtain $v_1(X_1)=\nicefrac{1}{2}$. Otherwise he would get $\nicefrac{1}{4}$ or $\nicefrac{2}{5}$. Hence, his best possible move is to make the middlecut.
\end{bsp}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{The Kuhn-Dawson Lone-Divider Protocol}
...
Each of the players $p_i$ and $p_j$ has to assume that he is the second last player. Player $p_i$ has to use Cut $\&$ Choose in that case, which is proven to be game-theoretic strategyproof.\\
For player $p_j$ the subsequent player $p_{j+1}$ is interested in the piece $I_k$ with probability $\nicefrac{1}{2}$ on which player $p_j$ has to take action. The residue of the cake $X'=I_k+I_k'=\nicefrac{2}{n}$. 
\begin{table}[htb]
		\centering
